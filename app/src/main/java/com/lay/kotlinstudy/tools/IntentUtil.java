package com.lay.kotlinstudy.tools;
...
public class IntentUtil {
    ...
    /**
     *  传递一个Map集合的Parcelable对象的数据
     * @Title: startActivity
     */
    public static <T> void doActionParcelable(Activity activity, Class<T> class1,
                                    HashMap<String, Parcelable> map) {
        synchronized (lock) {
            try {
                intent = new Intent(activity, class1);
                Bundle bundle = new Bundle();
